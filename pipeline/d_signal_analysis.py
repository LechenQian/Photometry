    ...
    for trialtype in trialtypes:
        ...
        for site in [key for key in mouse_trials[str(0)+'_'+all_days[0]]['corr_ROI'].keys()]:
            ...
            for index in range(len(all_days)):
                ...
                data[mouse_id][trialtype]['lickings'][site] = dataframe[is_x_TT].lickings
                # movement correction
...
#%% load existing data
data = load_pickleddata('D:/PhD/Photometry/DATA/round_20220504/processed/corrected_gcamp_data.pickle')
#%%
mouse_name = 'FgDA_02'
mouse = load_pickleddata('D:/PhD/Photometry/DATA/round_20220504/processed/{}_stats.pickle'.format(mouse_name))
#%%
...
for mouse_name in mice:
    ...
    for TT in trialtypes:
        ...
        savepath = 'D:/PhD/Photometry/DATA/round_20220504/figures'
...
mouse_name = 'FgDA_02'
good_sites = ['MNacS','PMOT','PMOT','LNacS']
