...
doric_data_folder = 'D:/PhD/Photometry/DATA/round_20220307/Test/Selina_C5D5R3E5R3/Session Data/doric/';
...
doric_file = dir(['*' mouse '_' protocol '_' day '*']); 
...
if ~isempty(doric_file)
    ...
    figure
    for i_ROI = 1:num_ROI
        ind = strfind(var_names, ['ROI' num2str(i_ROI-1)]);  % Because the Doric software names the first ROI as ROI0. Mine is 0,2,3,4,5,6,7,8,9,10,10,11
        Index = find(not(cellfun('isempty',ind)));
...
% session.name
beh_data_folder = ['D:/PhD/Photometry/DATA/round_20220307/Test/Selina_C5D5R3E5R3/Session Data/bpod/'];
beh_filename = [mouse '_' protocol '_' day '_' session];
...
foldername_tosave = 'D:/PhD/Photometry/DATA/round_20220307/Test/Selina_C5D5R3E5R3/Session Data/processed/';
filename_tosave = [mouse '_' protocol '_' day '_' session];
